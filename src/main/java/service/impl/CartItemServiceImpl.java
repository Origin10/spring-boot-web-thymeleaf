...
import repository.StuffToCartItemRepository;
import vo.Book;
...
public class CartItemServiceImpl implements CartItemService{
	...
	public CartItem addBookToCartItem(Book book, Mem_VO mem, int qty) {
		List<CartItem> cartItemList = findByShoppingCart(mem.getShoppingCart());
		...
		cartItem.setShoppingCart(mem.getShoppingCart());
